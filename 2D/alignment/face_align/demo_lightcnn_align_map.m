...
save_dir='/home/scw4750/BRL/LJ/lightcnn/bbox_probe';
name_lm_bbox_map_mat = '/home/scw4750/github/global_tool/2D/detection/mtcnn/name_lm_bbox_map.mat';
...
for i = 1:length(img_list)
    ...
    img_aligned = lightcnn_align_single(img, landmarks);
    idx = strfind(img_name, filesep);
    output_name = [save_dir filesep img_name(idx(end - residual_num + 1) + 1:end)];
